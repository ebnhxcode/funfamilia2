<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Nueva Condición de Vulnerabilidad'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Nueva Condición de Vulnerabilidad'); ?> <small><?php echo __('Nueva Condición de Vulnerabilidad'); ?></small></h1>
		</div>
	</div>
</div>
