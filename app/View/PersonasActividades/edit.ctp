<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Editar Inscripción'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Editar Inscripción'); ?> <small><?php echo __('Editar Inscripción'); ?></small></h1>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
					<?php echo $this->Form->input('CentroFamiliar.cefa_nombre', array('label' => __('Centro Familiar'), 'disabled' => 'disabled')); ?>
					<?php echo $this->Form->input('CentroFamiliar.cefa_id', array('type' => 'hidden', 'div' => false)); ?>
					<?php echo $this->Form->input('Actividad.acti_nombre', array('label' => __('Actividad'), 'disabled' => 'disabled')); ?>
					<?php echo $this->Form->input('Actividad.acti_id', array('type' => 'hidden', 'div' => false)); ?>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-bordered table-hover">
						...
						<tbody id="inscritos">
							<?php foreach($this->request->data['PersonaActividad'] as $peac): ?>
								<tr>
									<td>
										<?php echo $peac['PersonaCentroFamiliar']['Persona']['pers_run_completo']; ?>
									</td>
									<td>
										<?php echo $peac['PersonaCentroFamiliar']['Persona']['pers_nombre_completo']; ?>
									</td>
									<td>
										<a data-peac-id="<?php echo $peac['peac_id']; ?>" data-pecf-id="<?php echo $peac['PersonaCentroFamiliar']['pecf_id']; ?>" data-placement="top" data-original-title="Eliminar" class="btnEliminaInscripcion btn btn-xs btn-bricky tooltips" href="javascript:;">
...
$(document).on('click', '.btnEliminaInscripcion', function() {
	var peac_id = $(this).attr('data-peac-id');
	var t = $(this);

	$.ajax({
		type: 'POST',
		url: '/personas_actividades/deleteInscripcion',
		data: {
			peac_id: peac_id
		},
		cache: false,
...
$(document).ready(function() {
	var index = <?php echo sizeof($this->request->data['PersonaActividad']); ?>;
