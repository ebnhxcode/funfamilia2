...
<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Nueva Familia'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Nueva Familia'); ?> <small><?php echo __('Nueva Familia'); ?></small></h1>
		</div>
	</div>
</div>
							...
							<?php foreach($factoresRiesgos as $fari): ?>
								<tr>
									...
									<td>
										...
										<?php echo $this->Form->input('FactorRiesgoFamilia.'.$index.'.frfa_observaciones', array('type' => 'text', 'label' => false, 'div' => false)); ?>
									</td>
								</tr>
								<?php $index++; ?>
							<?php endforeach; ?>
							...
							<?php foreach($condicionesVulnerabilidad as $covu): ?>
								<tr>
									...
									<td>
										...
										<?php echo $this->Form->input('CondicionVulnerabilidadFamilia.'.$index.'.cvfa_observaciones', array('type' => 'text', 'label' => false, 'div' => false)); ?>
									</td>
								</tr>
								<?php $index++; ?>
							<?php endforeach; ?>
