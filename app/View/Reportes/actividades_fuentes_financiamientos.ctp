<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Actividades por Fuente de Financiamiento'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Actividades por Fuente de Financiamiento'); ?> <small><?php echo __('Actividades por Fuente de Financiamiento'); ?></small></h1>
		</div>
	</div>
</div>
