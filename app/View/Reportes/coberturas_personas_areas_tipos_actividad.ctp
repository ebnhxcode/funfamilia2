<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Reporte de Cobertura de Personas por area, tipos de actividad'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Reporte de Cobertura de Personas por area, tipos de actividad'); ?> <small><?php echo __('Reporte de Cobertura de Personas por area, tipos de actividad'); ?></small></h1>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<?php echo __('Cobertura de Personas'); ?>
			...
			<div class="panel-body">
				<?php echo $this->Form->create('Reporte'); ?>
					...
					<?php
						$pro_id = !empty($this->request->query['pro_id'])? $this->request->query['pro_id']: null;
						echo $this->Form->input('pro_id', array('label' => __('Programas'), 'options' => $programas, 'empty' => '', 'class' => 'form-control input-sm', 'selected' => $pro_id));
					?>
