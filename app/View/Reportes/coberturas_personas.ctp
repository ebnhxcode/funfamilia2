<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Reporte de Cobertura de Personas'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Reporte de Cobertura de Personas'); ?> <small><?php echo __('Reporte de Cobertura de Personas'); ?></small></h1>
		</div>
	</div>
</div>
