<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Resultados Evaluación Diagnóstica'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Resultados Evaluación Diagnóstica'); ?> <small><?php echo __('Resultados Evaluación Diagnóstica'); ?></small></h1>
		</div>
	</div>
</div>
