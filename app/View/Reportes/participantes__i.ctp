<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Detalle Actividades por Participante'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Detalle Actividades por Participante'); ?> <small><?php echo __('Detalle Actividades por Participante'); ?></small></h1>
		</div>
	</div>
</div>
