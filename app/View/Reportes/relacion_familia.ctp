<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Relación Familia y Categorías Diferentes'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Relación Familia y Categorías Diferentes'); ?> <small><?php echo __('Relación Familia y Categorías Diferentes'); ?></small></h1>
		</div>
	</div>
</div>
