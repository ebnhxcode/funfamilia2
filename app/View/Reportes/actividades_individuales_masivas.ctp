<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Reporte de Actividades individuales y masivas'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Reporte de Actividades individuales y masivas'); ?> <small><?php echo __('Reporte de Actividades individuales y masivas'); ?></small></h1>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<?php echo __('Actividades individuales y masivas'); ?>
