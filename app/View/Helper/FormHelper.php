 ...
 */
	public function error($field, $text = null, $options = array()) {
		...
		// para formularios clip-one
		$iTag = $this->Html->tag('i', '&nbsp;', array('class' => 'fa fa-info-circle'));
		return $iTag . $error;
 ...
 */
	public function input($fieldName, $options = array()) {
		...
		if ($tieneDiv) {
			...
			$out = array('before' => $options['before'], 'between' => $options['between'], 'after' => $options['after']);	
		}
		...
		// para formularios clip-one
		if ($tieneDiv) {
			if ($errorMessage && isset($errMsg)) {
				$iTag = null;
				$out['input'] .= $this->Html->tag('span', $iTag .$errMsg, array('class' => 'help-block')); 	
			}
			
			if (!isset($options['divClass'])) {
				$out['input'] = $this->Html->tag('div', $out['input'], array('class' => 'col-sm-9'));		
			} else {
				$out['input'] = $this->Html->tag('div', $out['input'], array('class' => $options['divClass']));
			}
		}
 ...
 */
	protected function _inputLabel($fieldName, $label, $options) {
		...
		if (!isset($labelAttributes['class'])) {
			$labelAttributes['class'] = 'col-sm-2 control-label';
		}
		...
		if (
			...
			$required = '&nbsp;'. $this->Html->tag('span', '', array('class' => 'symbol required'));
		}

		return $this->label($fieldName, $labelText . $required, $labelAttributes);
	}
 ...
 */
	public function checkbox($fieldName, $options = array()) {
		...
		// para formularios clip-one
		$options['class'] = 'grey';
		$output = $this->Html->tag('label', $output . $this->Html->useTag('checkbox', $options['name'], array_diff_key($options, array('name' => null))), array('class' => 'checkbox'));
		return $output;
