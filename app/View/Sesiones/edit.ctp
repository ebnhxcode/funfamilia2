<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Editar Sesión'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Editar Sesión'); ?> <small><?php echo __('Editar Sesión'); ?></small></h1>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php echo $this->Form->input('Sesion.sesi_nombre', array('label' => __('Sesión N°'), 'type' => 'number', 'disabled' => 'disabled')); ?>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			...
			<div class="panel-body" id="asistentes">
				<div class="row">
					<div class="col-xs-6">
						<?php echo $this->Html->link(__('Marcar/desmarcar asistentes') . ' <i class="fa fa-check-square"></i> ', 'javascript:;', array('escape' => false, 'class' => 'desmarcarAll btn btn-info pull-left')); ?>
					</div>
					<div class="col-xs-6">
					...
					<table id="asistentesTable" class="table table-bordered table-hover">
						...
						<tbody>
							...
							<?php foreach($asistencias as $asis): ?>
								<tr data-pers-run="<?php echo $asis['Persona']['pers_run']; ?>">
									...
									<td>
										<input class="checkAsistencia" checked="checked" name="data[Asistencia][<?php echo $index; ?>][pecf_id]" value="<?php echo $asis['PersonaCentroFamiliar']['pecf_id']; ?>" type="checkbox">
									</td>
								</tr>
							<?php $index++; ?>
							<?php endforeach; ?>
