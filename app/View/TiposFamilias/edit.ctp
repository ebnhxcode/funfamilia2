<div class="row">
	<div class="col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">
				<?php echo __('Editar Tipo de Familia'); ?>
			</li>
		</ol>
		<div class="page-header">
			<h1><?php echo __('Editar Tipo de Familia'); ?> <small><?php echo __('Editar Tipo de Familia'); ?></small></h1>
		</div>
	</div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php echo $this->Form->input('tifa_id'); ?>
